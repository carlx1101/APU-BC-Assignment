...
<header class="u-header">
	<div class="u-header-left">
		<a class="u-header-logo" href="{{ route('doctor.home') }}">
					...
					<div class="card-body p-0">
						<div class="list-group list-group-flush">
							...
							<a class="list-group-item list-group-item-action" href="#">
								<div class="media align-items-center">
									<img class="u-avatar--sm rounded-circle mr-3"
										src="{{asset('assets/img/avatars/img1.jpg')}}" alt="Image description">
							...
							<a class="list-group-item list-group-item-action" href="#">
								<div class="media align-items-center">
									<img class="u-avatar--sm rounded-circle mr-3"
										src="{{asset('assets//img/avatars/img2.jpg')}}" alt="Image description">
							...
							<a class="list-group-item list-group-item-action" href="#">
								<div class="media align-items-center">
									<img class="u-avatar--sm rounded-circle mr-3"
										src="{{asset('assets/img/avatars/user-unknown.jpg')}}" alt="Image description">
							...
							<a class="list-group-item list-group-item-action" href="#">
								<div class="media align-items-center">
									<img class="u-avatar--sm rounded-circle mr-3"
										src="{{asset('assets/img/avatars/img4.jpg')}}" alt="Image description">
					...
					<div class="card-body py-3">
						<div class="row">
							...
							<div class="col-4 px-2 mb-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img1.png') }}" alt="">
							...
							<div class="col-4 px-2 mb-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img2.png') }}" alt="">
							...
							<div class="col-4 px-2 mb-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img3.png')}}" alt="">
							...
							<div class="col-4 px-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img5.png')}}" alt="">
							...
							<div class="col-4 px-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img4.png')}}" alt="">
							...
							<div class="col-4 px-2">
								<a class="u-apps d-flex flex-column rounded" href="#!">
									<img class="img-fluid u-avatar--xs mx-auto mb-2"
										src="{{asset('assets/img/brands-sm/img6.png')}}" alt="">
						...
						<ul class="list-unstyled mb-0">
							<li class="mb-4">
								<a class="d-flex align-items-center link-dark" href="#!">
									<span class="h3 mb-0"><i class="far fa-user-circle text-muted mr-2"></i></span> View
									Profile
								</a>
							</li>
							<li class="mb-4">
							...
							{{-- <li class="mb-4">
								<a class="d-flex align-items-center link-dark" href="#!">
									<span class="h3 mb-0"><i class="far fa-laugh-wink text-muted mr-2"></i></span>
									Invite your friends
								</a>
							</li> --}}
							<li>
