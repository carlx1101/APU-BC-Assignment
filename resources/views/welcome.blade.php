                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black">Blockchain EHR System</h2>

                                        <p class="mt-4 text-sm/relaxed">
                                            This is the main page for the blockchain app. Login using the doctor
                                            credentials to view more functionalities.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href=""
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black">Patient</h2>
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black">Hospital Admin</h2>
